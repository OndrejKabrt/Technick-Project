...
class TeacherDAO:
    ...
    def save(self, teacher):
        sql = "INSERT INTO Teacher (first_name, last_name, teacher_username, teacher_password, email, phone_number) VALUES (%s, %s, %s, %s, %s, %s)"
    ...
    def delete(self, teacher_username):
        sql = "DELETE FROM Teacher WHERE teacher_username = %s"
