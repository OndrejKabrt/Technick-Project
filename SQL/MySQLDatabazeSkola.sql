...
SELECT id, first_name, last_name, user_name, user_password, number_in_class_order, is_student FROM Student;

Create view class_list AS
SELECT id, name, grade, number_of_class, year_of_entry, active, Class_Teacher_ID FROM Class;
