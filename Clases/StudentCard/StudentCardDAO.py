...
class StudentCardDAO:
    ...
    def save(self, student_card):
        sql = "INSERT INTO student_card (town, street, descriptive_number, zip_code, email, date_of_birth, phone_number, Student_ID) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
    ...
    def find_by_student_id(self, student_id):
        sql = "SELECT id, town, street, descriptive_number, zip_code, email, date_of_birth, phone_number, Student_ID FROM student_card WHERE Student_ID = ?"
        values = (student_id,)
