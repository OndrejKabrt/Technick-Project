from Clases.StudentCard.StudentCardApplication import StudentCardApplication

class StudentCardInterface:
    def __init__(self, interface):
        self.is_running = True
        self.interface = interface
        self.student_card_application = StudentCardApplication(self)
    ...
    def menu_input(self):
        commands = [
            ("Vložit", self.student_card_application.insertStudentCard),
            ("Find student card", self.student_card_application.findStudentCard),
            ("Zpět", self.terminate)
        ]
