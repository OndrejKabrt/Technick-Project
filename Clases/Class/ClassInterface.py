...
class ClassInterface:
    ...
    def menu_input(self):
        commands = [
            ...
            ("List classes", self.class_application.listClasses),
            ("Get students count", self.class_application.getStudentsCount),
            ("Set class previous students", self.class_application.setClassPreviousStudents),
            ("Zpět", self.terminate)
        ]
