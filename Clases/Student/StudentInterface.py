...
class StudentInterface:
    ...
    def menu_input(self):
        commands = [
            ...
            ("List all students", self.student_application.listStudents),
            ("List active students", self.student_application.listActiveStudents),
            ("Change student class", self.student_application.changeStudentClass),
            ("Get students in class", self.student_application.getStudentsInClass),
            ("Set previous student", self.student_application.setPreviousStudent),
            ("Zpět", self.terminate)
        ]
