from Clases.Subject.SubjectApplication import SubjectApplication

class SubjectInterface:
    def __init__(self, interface):
        self.is_running = True
        self.interface = interface
        self.subject_application = SubjectApplication(self)
    ...
    def menu_input(self):
        commands = [
            ("Vložit", self.subject_application.insertSubject),
            ("List subjects", self.subject_application.listSubjects),
            ("Zpět", self.terminate)
        ]
